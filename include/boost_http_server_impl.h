...
public:
	boost_http_server_impl(context_t& context) : m_serverAcceptor(context) { }
...
private:
	void start_accepting()
	{
		m_serverAcceptor.async_accept(
			std::bind(&boost_http_server_impl::handle_accept, this, std::placeholders::_1, std::placeholders::_2));
	}
