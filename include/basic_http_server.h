...
public:
	...
	void listen(callback_t callback = callback_t()) { listen(impl::default_port_value, callback); }

	void listen(port_t port, callback_t callback = callback_t()) { listen(port, impl::default_host_value, callback); }
	...
	void close(callback_t callback = callback_t()) { m_impl.close(callback); }
